  ...
  return (
              ...
              >
                <div className="copy_btn" onClick={() => handleCopy(item.url)}>
                  <img 
                    ...
                    alt="copy_icon" 
                    className="w-[40%] h-[40%] hover:scale-125 transition-all object-contain" 
                  />
                </div>
    ...
    <div className="my-10 max-w-full flex justify-center items-center">
      {isFetching ? (
        ...
        <p className="font-inter font-bold text-gray-600 text-center">
          Well, that wasn't supposed to happen...
          <br />
          <span className="text-red-700">{error?.data?.error}</span>
        </p>
      ) : (
        article.summary && (
          <div className="flex flex-col gap-3">
            ...
            <div className="summary_box">
              <p className="font-inter font-medium lg:text-base text-sm text-gray-500">
                {article.summary}
              </p>
            </div>
          </div>
